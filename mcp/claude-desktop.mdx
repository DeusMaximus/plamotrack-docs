...
description: "Configure Claude Desktop or Claude Code to use plamotrack's MCP server with a personal access token. Includes config for local, LAN, and TLS-enabled instances."
---
