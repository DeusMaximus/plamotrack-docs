...
<Steps>
  <Step title="Find the skill's zip">
    It's `plamotrack-gunpla.zip`, one of the release files: [Installation](/installation) downloaded it into your `plamotrack` folder. You can also download it from your version's [release page](https://github.com/DeusMaximus/plamotrack/releases). Use the zip as it is, without unpacking it.
  </Step>
  ...
  <Step title="Upload the skill">
    Click **Upload skill** and select `plamotrack-gunpla.zip`.
  </Step>
