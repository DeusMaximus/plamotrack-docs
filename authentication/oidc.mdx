...
description: "Configure plamotrack to authenticate through an OpenID Connect provider. Required for Claude web and ChatGPT OAuth-based MCP connections without pasting tokens."
---
